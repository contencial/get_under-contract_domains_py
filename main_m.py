...
def write_domain_list(domain_info):
    ...
    sheet = gc.open_by_key(SPREADSHEET_ID).worksheet('ムームー')
    ...
    cell_list[2].value = '=HYPERLINK("https://muumuu-domain.com/?mode=conpane", "Go to ムームー")'
...
if __name__ == '__main__':
    ...
    try:
        domain_info = modules.muu_muu_domain.get_domain_info()
        if not domain_info:
